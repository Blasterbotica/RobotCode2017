...
echo_and_run cd "/home/namwob44/turtlebot/src/turtlebot_create/create_node"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/namwob44/turtlebot/src/turtlebot_create/create_node/setup.py" \
    build --build-base "/home/namwob44/turtlebot/build/turtlebot_create/create_node" \
    install \
    $DESTDIR_ARG \
