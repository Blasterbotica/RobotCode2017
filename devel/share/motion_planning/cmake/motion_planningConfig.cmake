...
if("TRUE" STREQUAL "TRUE")
  set(motion_planning_SOURCE_PREFIX /home/namwob44/new_ws/src/motion_planning)
  set(motion_planning_DEVEL_PREFIX /home/namwob44/new_ws/devel)
  ...
  set(motion_planning_INSTALL_PREFIX /home/namwob44/new_ws/install)
...
if(NOT "/home/namwob44/new_ws/src/motion_planning/include " STREQUAL " ")
  set(motion_planning_INCLUDE_DIRS "")
  set(_include_dirs "/home/namwob44/new_ws/src/motion_planning/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'motion_planning' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'namwob44 <namwob44@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'motion_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/namwob44/new_ws/src/motion_planning/${idir}'.  Ask the maintainer 'namwob44 <namwob44@todo.todo>' to fix it.")
    endif()
    _list_append_unique(motion_planning_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "motion_planning_library")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/namwob44/new_ws/devel/lib;/home/namwob44/new_ws/devel/lib;/home/namwob44/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
set(depends "geometry_msgs;sensor_msgs;nav_msgs;roscpp;std_msgs;message_filters;actionlib;move_base_msgs;tf_conversions;eigen_conversions;actionlib")
