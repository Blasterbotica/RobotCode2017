...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motion_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/namwob44/new_ws/install/${idir}'.  Ask the maintainer 'namwob44 <namwob44@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/namwob44/new_ws/install/lib;/home/namwob44/new_ws/devel/lib;/home/namwob44/catkin_ws/devel/lib;/opt/ros/indigo/lib)
